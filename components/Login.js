      ...
      <div className="mt-2 lg:mt-5 container flex flex-col-reverse items-center lg:items-start lg:flex-row gap-6 ">
        ...
        <div className="flex-1 text-white/90">
          ...
          <p className="mt-[10px] text-xs leading-[21px]">
            ...
            even more traffic to them. Both standard and visiting ads include an
            elegant full page ad with up to 8 photos.
          </p>
          ...
          <p className="mt-[10px] text-xs leading-[21px]">
            ...
            beautifully laid-out advertisement on the premier website for adult
            entertainment services. Since 1997 we have been dedicated to
            bringing you high quality traffic, and it shows. Of course every
            provider is unique and we cannot guarantee you a specific number of
            leads from your advertisement. But we do know what it takes to
            ...
            service and sales staff in the industry. We are here to answer your
            questions and help you make the most of your advertising experience
            with the Eros Guide.
          </p>
        </div>
